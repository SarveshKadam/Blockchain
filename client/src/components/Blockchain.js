...
import { AiOutlineUser,AiOutlineFileText, AiOutlineDown } from "react-icons/ai";
    ...
    return (
        <div >
            ...
            <div className="list fixed-list">
                <strong>DATA : </strong><span><AiOutlineFileText /> Welcome to blockchain</span> <br />
                <strong>HASH : </strong><span className="hash-green"> 1256shjsjk12 </span> <br />
                <span className="genesis"> GENESIS BLOCK </span>
            </div>
            {blockList.map((value,key)=>(
                <div>
                <div key={key} className="list">
                <strong>DATA : </strong><span><AiOutlineFileText />{value.data}</span>  <br />
                <strong>HASH : </strong><span className="hash-green"> {value.hash} </span> <br />
            ...
            <Button className="create" variant="outline-dark" onClick={createBlock}> + ADD NEW BLOCK</Button>
            </Container>
            </div>
        </div>
    )
